...
const Home = () => {
    ...
    return (
        <div>
            <NavBar />
            {/* <div className="">
            <form className="flex flex-row gap-45">
            <p className="font-bold">blogverse</p>
            <p className="bg-blue-300 rounded-b-md text-blue-700">Home</p>
            <p className="font-bold">Sign in</p>
            <p className="bg-blue-600 rounded-b-sm">sign up</p>
            </form>
            </div> */}
            <div className="flex flex-col items-center">
                <h1 className=" flex flex-col font-semibold items-center text-2xl mt-10">welcome to blogverse</h1>
                <p className=" ">discovering amazing stories,insights and ideas from community of our writters</p>
                <Link to="login" className="text-blue-500 flex flex-row gap-5">SignIn<p className="text-gray-800">to create your own posts and save your favourites</p></Link>
            </div>
            <div>
                {
                    posts.map((post) => (
